...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<void> fetchDashboardStats() async {
    try {
      ...
      // Even if data is null → still show casted/pending values
      int indiaPopulation = 1430000000;
      ...
      setState(() {
        if (response.statusCode == 200 && resBody['success'] == true) {
          ...
          print("⚠ API missing data fields. Using fallback values.");
        }
      ...
      setState(() {
        votesCasted = (1430000000 * 0.70).toInt();
        votesPending = (1430000000 * 0.30).toInt();
        isLoading = false;
      });
    }
  }
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const ElectionDeclarationPage()),
              );
            },
          ),

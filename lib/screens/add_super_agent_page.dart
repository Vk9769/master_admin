...
class AddSuperAgentPage extends StatefulWidget {
  const AddSuperAgentPage({super.key});

  @override
  State<AddSuperAgentPage> createState() => _AddSuperAgentPageState();
}

class _AddSuperAgentPageState extends State<AddSuperAgentPage> {
  ...
  static const String _fixedRole = 'SUPER AGENT';
  ...
  Future<void> _submit() async {
    ...
    try {
      final uri = Uri.parse('$baseUrl/super_agent');
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Super Agent saved successfully')),
        );
        _resetForm();
      } else {
        ScaffoldMessenger.of(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Add Super Agent'),
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            ...
                            subtitle: const Text("Super Agent"),
                          ),
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: FilledButton.icon(
                                  ...
                                  label: Text(
                                    _loading ? 'Adding...' : 'Add Super Agent',
                                  ),
                                  style: FilledButton.styleFrom(
                                    backgroundColor: primary,

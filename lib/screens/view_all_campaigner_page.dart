...
class ViewCampaignerPage extends StatefulWidget {
  const ViewCampaignerPage({Key? key}) : super(key: key);

  @override
  State<ViewCampaignerPage> createState() => _ViewCampaignerPageState();
}

class _ViewCampaignerPageState extends State<ViewCampaignerPage>
